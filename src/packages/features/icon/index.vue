...
function copyIconCode(iconName: string, isCarbon = false) {
  const code = isCarbon
    ...
    : `<WdIcon name="${iconName}" size="20px" />`
...
<template>
  <view class="min-h-screen py-3">
    ...
    <!-- 图标大小选择 -->
    <DemoBlock title="图标大小" transparent>
      <view class="rounded-2 p-4 wot-bg-filled-oppo">
        ...
        <view class="wot-bg-bg flex items-center justify-center rounded-2 p-4 space-x-4">
          <WdIcon name="star" :size="currentIconSize" color="#f59e0b" />
    ...
    <!-- WotUI 图标 -->
    <DemoBlock title="WotUI 内置图标（精选示例）" transparent>
      <!-- 说明文字 -->
      ...
      <view class="grid grid-cols-3 gap-3 md:grid-cols-6 sm:grid-cols-4">
        ...
        >
          <view class="mb-2 flex justify-center">
            <WdIcon :name="icon.name" :size="currentIconSize" color="#666" />
          </view>
    ...
    <!-- Carbon 图标 -->
    <DemoBlock title="Carbon 图标集" transparent>
      <view class="mb-4 border border-blue-200 rounded-2 bg-blue-50 p-3 dark:border-blue-800 dark:bg-blue-900/20">
        <view class="mb-1 text-3.5 text-blue-700 font-bold dark:text-blue-300">
          💡 说明
        </view>
    ...
    <!-- 对比演示 -->
    <DemoBlock title="图标对比" transparent>
      <view class="rounded-2 p-4 wot-bg-filled-oppo">
          ...
          <view class="grid grid-cols-2 gap-4">
            <view class="rounded-2 bg-blue-50 p-4 text-center dark:bg-blue-900/20">
              ...
              <view class="mb-3 flex justify-center space-x-4">
                <WdIcon name="home" :size="20" color="#3b82f6" />
                <WdIcon name="search1" :size="20" color="#3b82f6" />
                <WdIcon name="star" :size="20" color="#3b82f6" />
                <WdIcon name="heart" :size="20" color="#3b82f6" />
              </view>
    ...
    <!-- 使用建议 -->
    <DemoBlock title="使用建议" transparent>
      <view class="space-y-3">
        <view class="rounded-2 p-4 wot-bg-filled-oppo">
    ...
    <DemoBlock title="相关链接" transparent>
      <WdCellGroup border custom-class="rounded-2! overflow-hidden">
        <WdCell title="📚 WotUI 图标文档" value="组件库文档" is-link @click="handleNavigate('https://wot-ui.cn/component/icon.html')" />
        <WdCell title="🎯 Carbon 图标集" value="IBM设计系统" is-link @click="handleNavigate('https://icones.js.org/collection/carbon')" />
        <WdCell title="🔧 Iconify 图标集" value="巨量图标合集" is-link @click="handleNavigate('https://iconify.design/')" />
        <WdCell title="⚡ UnoCSS 图标" value="原子化CSS图标" is-link @click="handleNavigate('https://unocss.dev/presets/icons')" />
      </WdCellGroup>
    </DemoBlock>
  </view>
</template>
